...
<template>
  <table class="data-table">
    ...
    <tr v-for="(song, index) in props.songs" :key="song.title" class="song">
          ...
          <div class="info" @dblclick="playItem(index)">
            <div class="detail">
              <p class="title">
                ...
                <span
                  v-show="
                    playState.playListName === props.playListName &&
      ...
      <td>{{ song.album }}</td>
      <td class="loved">
        <span v-if="song.isLoved"><i class="iconfont icon-love-fill"></i></span>
        <span v-else><i class="iconfont icon-love-outline"></i></span>
      </td>
